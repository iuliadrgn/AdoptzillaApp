...
public class SpecificAdImageAdapter extends RecyclerView.Adapter<SpecificAdImageAdapter.SpecificAdImageViewHolder>
{
    ...
    @NonNull
    @Override
    public SpecificAdImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SpecificAdImageViewHolder holder, int position) {
